    ...
    <div style="padding: 15px;">
        ...
        <div class="layui-tab layui-tab-brief">
            <ul class="layui-tab-title">
                ...
                <li  class="layui-this"><a href="mine_borrow_list_search.php">我的书籍</a></li>
            </ul>
        </div>
        <div class="layui-tab-container">
            <div class="layui-tab-content layui-show">
                ...
                <table class="layui-table" lay-data="{height:550,
                    ...
                    $search = $_POST['search'];
                    if ($search == '') {
                        alert("搜索内容为空", 'mine_book_list.php');
                    }
                    $username=$_SESSION["username"];
                    $sql = "SELECT * FROM borrow WHERE book_name LIKE '%" . $search . "%' 
                    and entry_user='$username' and state<3 ORDER BY id";
                    $result = $conn->query($sql);
                    if (!$result || mysqli_num_rows($result) < 1) {
                        alert("暂无数据", 'mine_book_list.php');
                    }
