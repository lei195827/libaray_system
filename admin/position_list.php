    ...
    <div style="padding: 15px;">
        ...
        <div class="layui-tab layui-tab-brief">
            <ul class="layui-tab-title">
                <li class="layui-this"><a href="position_list.php">位置列表</a></li>
        ...
        <div class="layui-tab-container">
            <div class="layui-tab-content layui-show">
                <div>
                    <form class="layui-form" action="position_list_search.php" method="post">
                ...
                <table class="layui-table" lay-data="{height:550,
                    ...
                    <tr>
                        ...
                        <td lay-data="{field:'other'}">位置说明</td>
